...
import Input from '../Components/Input';
import MainButton from '../Components/MainButton';
import { AdminNavbarData, CompanyNavbarData, StudentNavbarData, Gender } from '../Helper/constant'; // Assuming you have different navbar data for each userType
import Image from 'next/image';
import avater from '../Components/Assets/avater.png';
import Logout from '../Components/LogoutButton';
import CustomModal from '../Components/Modal';
...
const Profile = () => {
  ...
  if (auth.currentUser) {
    switch (auth.currentUser.userType) {
      case 'admin':
        ...
        break;
      case 'Company':
        navbarData = CompanyNavbarData;
        break;
      case 'student':
        navbarData = StudentNavbarData;
        break;
      default:
        break;
  ...
  console.log("userType:", auth.currentUser.userType);

  return (
    <div>
      <CustomLayout SideNavbarData={navbarData} pathname={pathname} className={'hiden'}>
        <div className="modal_styles">
          <div className="all_path">
            <CustomModal SideNavbarData={navbarData} pathname={pathname} />
            <div className="profile">
              <div className="avater_and_name">
                <Logout />
                <Label htmlFor="profilePicInput" className="avater_pencilicon">
